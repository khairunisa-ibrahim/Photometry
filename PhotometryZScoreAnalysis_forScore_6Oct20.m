...
REF_EPOC = 'Score'; %'PtAB'; % event store name. This holds behavioral codes that are read through Ports A & B on the front of the RZ
...
data = TDTfilter(data, REF_EPOC, 'VALUES', VALUE, 'TIME', TRANGE); %for Score
